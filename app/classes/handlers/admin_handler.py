        ...
        if page == 'change_password':
            ...
            if server_path_exists and jar_exists:
                MC_settings.update({
                    ...
                    MC_settings.auto_start_server: int(bleach.clean(self.get_argument('auto_start_server'))),
                    MC_settings.auto_start_delay: int(bleach.clean(self.get_argument('auto_start_delay'))),
                    MC_settings.auto_start_priority: int(bleach.clean(self.get_argument('auto_start_priority'))),
                    MC_settings.crash_detection: int(bleach.clean(self.get_argument('crash_detection'))),
                    MC_settings.server_port: int(bleach.clean(self.get_argument('server_port'))),
